...
import static com.softjk.waitapp.Negocio.FragmentSala.SalaN3.viewGroupN3;
...
public class AdpSala3Neg extends FirestoreRecyclerAdapter<Sala, AdpSala3Neg.ViewHolder> {
    ...
    private OnItemPrimerID3 callback;
    public interface OnItemPrimerID3{
        void OnItemPrimerIDFound(String id);
    }
    public void setOnItemID(OnItemPrimerID3 callback){
        this.callback = callback;
    }


    // ********* Interfaz ID para Iniciar Contador **********
    private IDContador3 callbackContador;
    public interface IDContador3{
        void OnIDContadorFound(String id);
    }
    public void setOnIDContador(IDContador3 callbackContador){this.callbackContador = callbackContador;}
    ...
    protected void onBindViewHolder(@NonNull AdpSala3Neg.ViewHolder holder, int position, @NonNull Sala model) {
        ...
        if (model.getUser().equals("RECESO")){
            ...
            holder.Usuario.setTextColor(Color.parseColor("#6ac458"));
            ...
            if (position == 0){
                ...
                callbackContador.OnIDContadorFound(id);
                //TiempoGlobalPers.reiniciarTemporizador("Negocios/" + idUser + "/Sala3", id, holder.ContadorItem, activity, "3");
        ...
        holder.Mas5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position == 0) { //Primera accion
                    ...
                    AddMasTime.ActualizarTimeUser0(activity, 5, idUser, "3", id, TiempoAdmin, Accion, TiempoServ, list, new AddMasTime.GuardarCallback() {
                        @Override
                            ...
                            if (resultado.equals("Exito")){
                                ...
                                for (int i = 0; i < getSnapshots().size(); i++) {
                                    ...
                                    if (item != null) {
                                        ...
                                        AddMasTime.ActualizarTimeGeneral(idUser, idItem, tiempo, 300,"3",activity,acion,tiempoAdmin);
                                    }else {System.out.println("No entro a la acion3");}
                                }
        ...
        holder.Mas10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position == 0) { //Primera accion
                    ...
                    String Accion = model.getAccion();
                    String list = preferencesManager.getString("SalaVacio3", "");
                    AddMasTime.ActualizarTimeUser0(activity, 10, idUser, "3", id, TiempoAdmin, Accion, TiempoServ, list, new AddMasTime.GuardarCallback() {
                        @Override
                        public void onResultado(String resultado) {
                            if (resultado.equals("Exito")){
                                //Segunda acion para todos los elementos
                                ...
                                for (int i = 0; i < getSnapshots().size(); i++) {
                                    ...
                                    if (item != null) {
                                        ...
                                        System.out.println("idUser:"+idItem);
                                        System.out.println("timeServ:"+tiempo);
                                        AddMasTime.ActualizarTimeGeneral(idUser, idItem, tiempo, 600,"3",activity,acion,tiempoAdmin);
                                    }else {System.out.println("No entro a la acion3");}
                                }
                                Intent intent = activity.getIntent();
                                activity.finish();
    ...
    private void ClicElim(LinearLayout lis, String Precio, String Cliente, String Servicio, String IdCliet, String Pago) {
        lis.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                String Collecction = "Negocios/"+idUser+"/Sala3";

                AlertDialogMetds.MsgEliminarAdmin(activity,"Desea Eliminar a "+Cliente,Servicio,IdCliet,Collecction,Pago,Precio,viewGroupN,"3");
                return true;
            }
        });
    }
